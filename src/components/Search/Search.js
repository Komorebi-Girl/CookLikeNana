...
class Search extends Component {
  ...
  loadNanas = event => {
    ...
    API.getNanas({
      ...
      .catch(err => console.log("There's an error, dude"));
  };
              ...
              <div className="row" style={{ width: "800px" }}>
                <div className="form-group col-md-12 text-center">
                  <input
                    ...
                    id="italiancuisine"
                    name="italiancuisine"
                    value={this.state.italiancuisine}
                    onChange={this.handleInputChange}
                  />
                  <label for="italiancuisine">
                    &nbsp;Italian Cuisine&nbsp;&nbsp;&nbsp;
                  </label>
                  <input
                    type="checkbox"
                    style={{ width: "20px" }}
                    id="southerncuisine"
                    name="southerncuisine"
                    value={this.state.southerncuisine}
                    onChange={this.handleInputChange}
                  />
                  <label for="southerncuisine">
                    &nbsp;Southern Cuisine&nbsp;&nbsp;&nbsp;
                  </label>
                  <input
                    type="checkbox"
                    style={{ width: "20px" }}
                    id="hispaniccuisine"
                    name="hispaniccuisine"
                    value={this.state.hispaniccuisine}
                    onChange={this.handleInputChange}
                  />
                  <label for="hispaniccuisine">
                    &nbsp;Hispanic Cuisine&nbsp;&nbsp;&nbsp;
                  </label>
                  <input
                    type="checkbox"
                    ...
                    value={this.state.vegetarianvegan}
                    onChange={this.handleInputChange}
                  />
                  <label for="vegcuisine">
