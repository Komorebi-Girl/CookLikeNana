...
const style = {
  ...
  height: '500px',
  position: 'relative',
  background: '-moz-linear-gradient(45deg, rgba(174,87,179,1) 0%, rgba(228,155,235,1) 40%, rgba' +
      '(255,213,158,1) 100%)',
  background: '-webkit-gradient(linear, left bottom, right top, color-stop(0%, rgba(174,87,179,' +
          ...
          <div className="skew">
            <div className="header-inner">
              ...
              <video loop id="myVideo" autoPlay>
                <source
                  src="https://www.videvo.net/videvo_files/converted/2014_11/preview/Baking_Cookies_Videvo.mp450092.webm"/>
    ...
    <main class="main">
      <div class="main-container">
        ...
        <section-slant>
          ...
          <h5>Depending on whether you want to sign up as a cook or learner it works a bit
            differently:</h5>
        </section-slant>
      </div>
    </main>
