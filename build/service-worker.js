...
var precacheConfig = [
        [
            "/index.html", "c841bcd1dea0cb8a76254258def09645"
        ],
        [
            "/static/css/main.4e8ed93f.css", "f4886e35838d8c80c0ce5e488b818312"
        ],
        [
            "/static/js/main.2ef19deb.js", "501ce16353b12f305cae04c521fcbc3e"
        ],
        ["/static/media/logo.550e468a.png", "550e468a399579c474cf7e36e1642fc5"]
    ],
...
self.addEventListener("fetch", function (e) {
    if ("GET" === e.request.method) {
        ...
        var a = "/index.html";
        !t && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL(a, self.location).toString(), t = urlsToCacheKeys.has(n)),
